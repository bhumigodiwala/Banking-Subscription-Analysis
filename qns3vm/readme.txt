...
examples.py
	supprt file of examples in QNS3VM, modified to work in Python3
qns3vm.py
	main file of QNS3VM, modified to work in Python3

Running the command "python qns3vm.py" should yield an output similar to:
# 
